...
/**
 * Canonical Circle Select coordinate space.
 *
 * View text and merged text indexes live in absolute screen coordinates. Screenshot cropping and
 * bitmap resolution are separate concerns and are converted explicitly at the boundary.
 */
final class CircleCoordinateSpace {
    private final Rect screenFrame;
    private final int bitmapWidth;
    private final int bitmapHeight;

    CircleCoordinateSpace(Rect screenFrame, int bitmapWidth, int bitmapHeight) {
    ...
    RectF screenRectToView(Rect screenRect, int viewWidth, int viewHeight) {
    ...
    Rect viewRectToScreen(RectF viewRect, int viewWidth, int viewHeight) {
    ...
    OcrDocument bitmapDocumentToScreen(OcrDocument document) {
